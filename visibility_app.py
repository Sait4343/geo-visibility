            ...
            for p in projects:
                with st.container(border=True):
                    ...
                    with col_center:
                        ...
                        st.markdown(f"**Послуги:** {prods[:100]}...")
